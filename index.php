...
<html lang="en">
  ...
  <head>
    ...
    <title>Amandeep Malhi - Portfolio</title>
        ...
        <div class="header">
          ...
          <!-- <div class="Icon_Banner">
            ...
            <a href="#coder" class="noLine">
              <div class="Icon">
                <img src="img/code_icon.png" alt="White icon for a code program." class="Icon_Img">
                <div>
                  <p class="Icon_Text">Programmer</p>
                </div>
              </div>
            </a>

            <a href="#GD" class="noLine">
              <div class="Icon">
                <img src="img/gd_icon.png" alt="White laptop Icon with text and an image on the screen." class="Icon_Img">
                <div>
                  <p class="Icon_Text">Graphic Designer</p>
                </div>
              </div>
            </a>

            <a href="#threeD" class="noLine">
              <div class="Icon">
                <img src="img/3D_icon.png" alt="White 3D sphere icon." class="Icon_Img">
                <div>
                  <p class="Icon_Text">3D Designer</p>
                </div>
              </div>
            </a>
    ...
    <div class="body">
      ...
      <div class="navSection">
        <nav class="navBar">
          ...
          <a href="#aboutMe" class="navItems">ABOUT ME</a>
          <a href="#contactMe" class="navItems">CONTACT ME</a>
        ...
        <div class="split">
          <div class="form">
                    ...
                    <div class="name_and_email">
    									...
    									<div class="name_input"> <!-- field half first -->
    									...
    									<div class="email_input"> <!-- field half first -->
  									...
  									<div class="message_input"> <!-- field half first -->

  										<label >MESSAGE</label> <!-- for="message" -->

  										<textarea name="Message" id="Message" rows="6"></textarea>

  									</div>

  									<div class="actions"> <!-- field half first -->

  										<input type="submit" value="SEND MESSAGE" class="Button_Submit" />
          ...
          <div class="side_contact">
            ...
            <div class="contact_section">
              <a href="Amandeep_Malhi-Resume.pdf" class="white_contact" target="_blank"><h3 class="white">DOWNLOAD MY RESUME</h3></a>
            </div>
